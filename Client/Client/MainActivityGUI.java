...
public class MainActivityGUI implements ActionListener, ListSelectionListener {
	 ...
	 static JFrame frame;
	 JList<chatGUI> privateChatList;
	 JList<chatGUI> groupChatList;
	 static DefaultListModel<chatGUI> privateChatDLM;
	 static DefaultListModel<chatGUI> groupChatDLM;
	 JButton Change;
	 NewChatGUI newChat;
...
//		ImageIcon userIcon = new ImageIcon(getClass().getResource("/images/user.png"));
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if(privateChatList.getSelectedIndex()!=-1) {
			...
			chatGUI x=privateChatList.getSelectedValue();
			x.setVisible(true);
			}
		...
		if(groupChatList.getSelectedIndex()!=-1) {
			if(p.isVisible()) {
				...
				groupChatList.getSelectedValue().setVisible(true);
			}
